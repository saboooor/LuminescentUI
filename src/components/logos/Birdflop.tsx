...
export const LogoBirdflop = component$<LogoBirdflopProps>(({ confused, fillGradient, ...props }) => {
  return (
        ...
        { fillGradient &&
          <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
            {fillGradient.map((color, i) => (
              <stop key={i} offset={i / (fillGradient.length - 1)} stop-color={color} />
            ))}
          </linearGradient>
        }
