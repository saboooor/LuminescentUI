...
export class ColorPicker {
   ...
   */
  public appendTo(el: HTMLElement | string) {
    if (typeof el === 'string') {
  ...
  /* =============================================================================
    Private methods
  ============================================================================= */
  private _moveSelectorTo(x: number, y: number) {
  ...
  /* =============================================================================
    Events handlers
  ============================================================================= */
  private _onSaturationMouseDown = (e: MouseEvent | TouchEvent) => {
  ...
  private _onSaturationMouseMove = (e: MouseEvent | TouchEvent) => {
    const sbOffset = this.$saturation.getBoundingClientRect();
    const { x, y } = getMousePosition(e);
    this._moveSelectorTo(x - sbOffset.left, y - sbOffset.top);
    this._updateColorFromPosition();
  ...
  private _onHueMouseDown = (e: MouseEvent | TouchEvent) => {
