...
const AutoComplete = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES$1, "AutoComplete_component_useStylesScoped_0FprNR9i0NU"));
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", null, {
    ...
    state.suggestions.length > 0 && state.showSuggestions ? /* @__PURE__ */ qwik._jsxQ("ul", null, {
      ...
      return /* @__PURE__ */ qwik._jsxQ("li", {
        ...
        item
      }, 3, "y0_0") : /* @__PURE__ */ qwik._jsxQ("span", null, null, transform(props, state, item), 1, null), 0, idx);
    }), 1, "y0_1") : null
  ], 1, "y0_2");
...
const TodoApp = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES, "TodoApp_component_useStylesScoped_h0RfHVJErY0"));
  const state = qwik.useStore({
    list: [
      "hello",
      "world"
